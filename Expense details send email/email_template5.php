<?php 
 ...
 $payment_currence = $_POST['payment_currence'];
 //$estimate_date_d = $_POST['estimate_date_d'];
 //$estimate_date_m = $_POST['estimate_date_m'];
 //$estimate_date_y = $_POST['estimate_date_y'];
// $date = $estimate_date_d.' / '.$estimate_date_m.' / '.$estimate_date_y;
...
// subject
$subject = 'PAYMENT TO CREDIT CARD';
...
<html>
<head>
	<title>PAYMENT TO CREDIT CARD</title>
